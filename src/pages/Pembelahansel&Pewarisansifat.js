...
function PembelahanselPewarisansifat() {
  const appStyle = {
  ...
  const boxStyle = {
    backgroundColor: '#f0f0f0', // Background color set to light grey
    padding: '20px',
    borderRadius: '8px',
    marginBottom: '20px',
  ...
  return (
    <div style={appStyle}>
      <div style={containerStyle}>
        <h1 style={headingStyle}>Pembelahan Sel & Pewarisan Sifat</h1>

        <section style={sectionStyle}>
          <div style={boxStyle}>
            <h2 style={cardTitleStyle}>1. Pembelahan Sel</h2>
        ...
        <section style={sectionStyle}>
          <div style={boxStyle}>
            <h2 style={cardTitleStyle}>2. Pewarisan Sifat</h2>
            <p style={paragraphStyle}>
...
export default PembelahanselPewarisansifat;
