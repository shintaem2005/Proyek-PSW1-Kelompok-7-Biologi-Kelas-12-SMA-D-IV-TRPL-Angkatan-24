...
function SubstansiMateriGenetika() {
    return (
        <div style={styles.container}>
            ...
            <section style={styles.introSection}>
                ...
                <img
                    src="https://mmc.tirto.id/image/2024/01/02/ilustrasi-dna-istock-1447532807_ratio-16x9.jpg"
            ...
            <section style={styles.featuresSection}>
                ...
                <div style={styles.features}>
                    <div style={styles.featureCard}>
                        <img
                            src="https://sp-ao.shortpixel.ai/client/to_webp,q_glossy,ret_img/https://almuhsin.id/wp-content/uploads/2022/11/43067-1-1280x640.jpg"
                    ...
                    <div style={styles.featureCard}>
                        <img
                            src="https://assets-a3.kompasiana.com/items/album/2023/07/19/delicious-arrangement-gmo-modified-food-64b78c8e08a8b56dea226982.jpg?t=o&v=410"
                    ...
                    <div style={styles.featureCard}>
                        <img
                            src="https://www.pilar.id/wp-content/uploads/2024/03/img-pilar-ilustrasi78669-768x512.webp"
                            alt="Medis"
                            style={styles.cardImage}
                        />
                        <h3>Medis</h3>
...
const styles = {
    ...
    largeImage: { width: "50%", borderRadius: "20px", alignSelf: "center" },
...
export default SubstansiMateriGenetika;